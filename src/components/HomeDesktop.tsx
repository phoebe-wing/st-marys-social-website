...
export const HomeDesktop = (): JSX.Element => {
  ...
  // Build array: [last 3 clones] + [all originals] + [first 3 clones]
  ...
  const handleSnap = useCallback((newIndex: number) => {
    // Use rAF to ensure the snap (no-transition) renders before re-enabling
  ...
  return (
    <div className="flex flex-col items-start relative">
      <header className="flex flex-col h-[72px] items-center justify-center pr-[var(--spacing-sizing-page-padding-padding-global)] pl-[var(--spacing-sizing-page-padding-padding-global)] py-0 relative self-stretch w-full bg-color-schemes-color-scheme-3-background">
        <nav
          className="justify-center gap-8 self-stretch w-full flex items-center relative flex-[0_0_auto]"
          aria-label="Main navigation"
        >
          <div className="flex flex-col items-start relative flex-1 grow">
            <div className="inline-flex items-start relative flex-[0_0_auto]">
              <div
                className="relative w-[47px] h-[47px] mt-[-1.00px] mb-[-1.00px] ml-[-1.00px] mr-[-1.00px] rounded-[100px] border border-solid border-white bg-cover bg-center"
                style={{ backgroundImage: `url(${logo})` }}
                role="img"
                aria-label="St. Mary's Social logo"
              />
              <div className="absolute top-[calc(50.00%_-_16px)] left-[45px] w-[242px] font-heading-h6 font-[number:var(--heading-h6-font-weight)] text-white text-[length:var(--heading-h6-font-size)] tracking-[var(--heading-h6-letter-spacing)] leading-[var(--heading-h6-line-height)] [font-style:var(--heading-h6-font-style)]">
                &nbsp;&nbsp;St. Mary&apos;s Social
              </div>
            </div>
          </div>
          <div className="flex flex-col items-end justify-center relative flex-1 grow">
            <ul className="inline-flex items-center gap-8 relative flex-[0_0_auto] list-none m-0 p-0">
              {socialLinks.map((link, index) => (
                ...
                >
                  <a
                    ...
                    className="relative w-fit mt-[-1.00px] font-text-regular-normal font-[number:var(--text-regular-normal-font-weight)] text-color-schemes-color-scheme-3-text text-[length:var(--text-regular-normal-font-size)] tracking-[var(--text-regular-normal-letter-spacing)] leading-[var(--text-regular-normal-line-height)] whitespace-nowrap [font-style:var(--text-regular-normal-font-style)] no-underline hover:underline"
                  >
                    {link.label}
                  </a>
                </li>
      ...
      <section
        className="relative flex flex-col items-center gap-20 pt-[var(--spacing-sizing-section-padding-padding-section-large)] pr-[var(--spacing-sizing-page-padding-padding-global)] pb-[var(--spacing-sizing-section-padding-padding-section-large)] pl-[var(--spacing-sizing-page-padding-padding-global)] self-stretch w-full flex-[0_0_auto] overflow-hidden"
      ...
      >
        <div className="flex flex-col items-center gap-20 pt-[var(--spacing-sizing-section-padding-padding-section-large)] pr-[var(--spacing-sizing-page-padding-padding-global)] pb-[var(--spacing-sizing-section-padding-padding-section-large)] pl-[var(--spacing-sizing-page-padding-padding-global)] relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex flex-col max-w-[var(--spacing-sizing-container-container-large)] items-center gap-20 relative w-full flex-[0_0_auto]">
            <div className="flex flex-col max-w-[var(--spacing-sizing-max-width-max-width-large)] items-center gap-8 relative w-full flex-[0_0_auto]">
              <div className="flex flex-col items-center gap-6 relative self-stretch w-full flex-[0_0_auto]">
                ...
                <p className="relative self-stretch font-text-medium-normal font-[number:var(--text-medium-normal-font-weight)] text-color-schemes-color-scheme-3-text text-[length:var(--text-medium-normal-font-size)] text-center tracking-[var(--text-medium-normal-letter-spacing)] leading-[var(--text-medium-normal-line-height)] [font-style:var(--text-medium-normal-font-style)]">
              ...
              <div className="inline-flex items-start gap-4 relative flex-[0_0_auto]">
                {socialLinks.map((link, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`all-[unset] box-border inline-flex items-center justify-center gap-2 px-6 py-2.5 relative flex-[0_0_auto] mt-[-4.00px] mb-[-4.00px] bg-[color:var(--primitives-color-corn)] rounded-[100px] border-b-4 [border-bottom-style:solid] border-primitives-color-corn-dark cursor-pointer hover:opacity-90 transition-opacity ${index === 0 ? "ml-[-4.00px]" : ""} ${index === socialLinks.length - 1 ? "mr-[-4.00px]" : ""}`}
                  >
            ...
            <div className="w-[640px] justify-around gap-2.5 flex items-center relative flex-[0_0_auto]">
              <img
                className="w-[590px] h-[786.67px] aspect-[0.75] relative object-cover"
                alt="Upcoming event poster"
                src={upcomingEventImage}
              />
              <div className="absolute top-[368px] left-[590px] w-[50px] h-[50px]" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section
        className="flex flex-col items-center gap-20 pt-[var(--spacing-sizing-section-padding-padding-section-large)] pr-[var(--spacing-sizing-page-padding-padding-global)] pb-[var(--spacing-sizing-section-padding-padding-section-large)] pl-[var(--spacing-sizing-page-padding-padding-global)] relative self-stretch w-full flex-[0_0_auto] bg-color-schemes-color-scheme-4-background"
      ...
      >
        <div className="flex flex-col max-w-[var(--spacing-sizing-container-container-large)] items-center gap-20 relative w-full flex-[0_0_auto]">
          <div className="flex flex-col max-w-[var(--spacing-sizing-max-width-max-width-large)] items-center gap-6 relative w-full flex-[0_0_auto]">
            ...
            <p className="text-[color:var(--color-schemes-color-scheme-4-text)] text-[length:var(--text-medium-normal-font-size)] text-center leading-[var(--text-medium-normal-line-height)] relative self-stretch font-text-medium-normal font-[number:var(--text-medium-normal-font-weight)] tracking-[var(--text-medium-normal-letter-spacing)] [font-style:var(--text-medium-normal-font-style)]">
          ...
          <div className="relative self-stretch w-full flex-[0_0_auto]">
            <div className="overflow-hidden">
              <div
                ...
                style={{ transform: `translateX(calc(-${slideIndex} * (40% + 24px)))` }}
              ...
              >
                {extendedImages.map((image, index) => (
                  <img
                    key={index}
                    className="w-[40%] flex-shrink-0 aspect-square object-cover rounded-[var(--UI-styles-radius-large)]"
                    alt={image.alt}
                    src={image.src}
                  />
                ))}
            ...
            <button
              ...
              className="absolute top-1/2 left-4 -translate-y-1/2 inline-flex items-center justify-center p-3 bg-color-schemes-color-scheme-4-foreground rounded-full border border-solid border-color-schemes-color-scheme-4-background cursor-pointer hover:opacity-80 transition-opacity"
              aria-label="Previous slide"
            >
              <ArrowBack className="!relative !w-6 !h-6" />
            </button>
            <button
              onClick={handleNextSlide}
              className="absolute top-1/2 right-4 -translate-y-1/2 inline-flex items-center justify-center p-3 bg-color-schemes-color-scheme-4-foreground rounded-full border border-solid border-color-schemes-color-scheme-4-background cursor-pointer hover:opacity-80 transition-opacity"
              aria-label="Next slide"
            >
              <ArrowForward className="!relative !w-6 !h-6" />
            </button>
            <div
              className="flex items-center gap-[9px] p-2.5 w-full justify-center mt-6"
              role="tablist"
      ...
      <section
        className="flex flex-col items-center gap-20 pt-[var(--spacing-sizing-section-padding-padding-section-large)] pr-[var(--spacing-sizing-page-padding-padding-global)] pb-[var(--spacing-sizing-section-padding-padding-section-large)] pl-[var(--spacing-sizing-page-padding-padding-global)] relative self-stretch w-full flex-[0_0_auto] bg-color-schemes-color-scheme-3-background"
        aria-labelledby="community-heading"
      >
        <div className="flex flex-col max-w-[var(--spacing-sizing-container-container-large)] items-center gap-20 relative w-full flex-[0_0_auto]">
          <div className="flex flex-col max-w-[var(--spacing-sizing-max-width-max-width-medium)] items-center gap-16 relative w-full flex-[0_0_auto]">
            <div className="flex flex-col items-center gap-6 relative self-stretch w-full flex-[0_0_auto]">
              <div
